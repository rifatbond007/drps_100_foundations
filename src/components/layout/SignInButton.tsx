 ...
 * doesn't navigate, which looks like the click did nothing.
 *
 * `void signIn(...)` deliberately discards the returned Promise: awaiting
 * it would block the click handler and (worse) the navigation the call
 * triggers would race the await chain.
 */
'use client';
