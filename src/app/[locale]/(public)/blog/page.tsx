...
/**
 * /[locale]/blog — placeholder.
 *
 * Full blog pipeline (CMS, posts, RSS) is not built yet; this page is a
 * styled "coming soon" so the navbar link lands somewhere on-brand. When
 * the blog ships, replace the body of this page with the post list view
 * — keep the same Hero-style header so the page transition is seamless.
 */
